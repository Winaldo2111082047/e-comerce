    ...
    <div className="min-h-[60vh] flex items-center justify-center px-4 py-16">
      <div className="max-w-md w-full text-center">
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400 mb-2">
          Halaman ini tidak bisa dimuat saat ini. Coba lagi atau kembali ke halaman lain.
        </p>
        ...
        {process.env.NODE_ENV === 'development' && error.message && (
          <div className="mb-5 text-left bg-orange-50 dark:bg-orange-900/20 border border-orange-200 dark:border-orange-800 rounded-xl p-3">
            <p className="text-xs font-semibold text-orange-700 dark:text-orange-400 mb-1">Dev Info:</p>
            <p className="text-xs text-orange-600 dark:text-orange-300 font-mono break-all">{error.message}</p>
          </div>
        )}
